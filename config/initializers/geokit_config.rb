...
Geokit::Geocoders::YahooGeocoder.key = ENV['yahoo_geocoder_key']
Geokit::Geocoders::YahooGeocoder.secret = ENV['yahoo_geocoder_secret']
...
Geokit::Geocoders::GeonamesGeocoder.key = 'droptune'
...
Geokit::Geocoders::provider_order = [:yahoo, :geonames]
