...
class ArtistSerializer < ActiveModel::Serializer
  attributes :id, :name, :genres, :year_started, :year_ended, :external_homepage, :external_twitter, :external_facebook, :external_instagram, :external_wikipedia, :external_youtube, :spotify_link, :spotify_id, :applemusic_id, :spotify_image, :spotify_followers, :spotify_popularity, :imvdb_last_updated_at, :musicbrainz_last_updated_at, :spotify_last_updated_at, :applemusic_last_updated_at, :created_at, :updated_at
